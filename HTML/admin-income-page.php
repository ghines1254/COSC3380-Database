...
<html>
  ...
  <body>
    <div class="admin-products-page">
      ...
      <div class="admin-products-outline">
        <div class="rectangle-parent108">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent109">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent110">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent111">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent112">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent113">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent114">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="rectangle-parent115">
          <div class="group-child65"></div>
          <div class="stock-1">Stock: 1</div>
        </div>
        <div class="products-outline1">
          <div class="check-out-the1">
            Check out the great items we have available in our store. Come see
            for yourself!
          </div>
          <div class="vector-parent3">
            <img class="vector-icon44" alt="" src="./public/vector3.svg" />

            <div class="large-box-499-container1">
              <p class="large-box2">Large Box</p>
              <p class="large-box2">$4.99</p>
            </div>
            <img class="vector-icon45" alt="" src="./public/vector4.svg" />

            <img class="vector-icon46" alt="" src="./public/vector3.svg" />

            <div class="small-box-299-container1">
              <p class="large-box2">Small Box</p>
              <p class="large-box2">$2.99</p>
            </div>
            <div class="envelope-1991">
              <p class="large-box2">Envelope</p>
              <p class="large-box2">$1.99</p>
            </div>
            <div class="medium-box-399-container1">
              <p class="large-box2">Medium Box</p>
              <p class="large-box2">$3.99</p>
            </div>
            <img class="vector-icon47" alt="" src="./public/vector6.svg" />
          </div>
          <div class="vector-parent4">
            <img class="vector-icon48" alt="" src="./public/vector8.svg" />

            <div class="tape-4991">
              <p class="large-box2">Tape</p>
              <p class="large-box2">$4.99</p>
            </div>
            <div class="stapler-4991">
              <p class="large-box2">Stapler</p>
              <p class="large-box2">$4.99</p>
            </div>
            <div class="pen-10pk-299-container1">
              <p class="large-box2">Pen 10pk</p>
              <p class="large-box2">$2.99</p>
            </div>
            <div class="stamp-booklet-999-container1">
              <p class="large-box2">Stamp Booklet</p>
              <p class="large-box2">$9.99</p>
            </div>
            <img class="vector-icon49" alt="" src="./public/vector9.svg" />

            <img class="vector-icon50" alt="" src="./public/vector10.svg" />

            <img class="vector-icon51" alt="" src="./public/vector11.svg" />
          </div>
        </div>
      </div>
      <img
