...
if($_SERVER["REQUEST_METHOD"] === "POST")
{
    ...
    $stmt = $conn->prepare("INSERT INTO CUSTOMER (customer_phone, customer_id, zip, state, street_address_1, city, first_name, last_name, email, PASSWORD, street_address_2) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");  
    $stmt->bind_param("sssssssssss", $phoneNum, $customerID, $zipcode, $state, $address1, $city, $firstName, $lastName, $email, $password, $address2);
    echo "\n";
